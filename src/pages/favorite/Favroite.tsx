...
import {getItemFromFavorite, addItemToFavorite, updateItemToFavorite, removeItemToFavorite} from "../favorite/favorite.slice"
            ...
            return (
                <div style={{paddingBottom:"1rem", display:'inline-block', width:"100%"}} key={index}>
                      ...
                      <Card2
                        ...
                        handleQuantityChange={(value)=>{dispatch(updateItemToFavorite({...item, quantity: value}))}}
                        handleAddToDeleteClick={(productId)=>{dispatch(removeItemToFavorite({productId}))}}
